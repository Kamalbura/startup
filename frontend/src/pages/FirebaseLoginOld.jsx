  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-white via-slate-50 to-blue-50/30">
      ...
      >
        ...
        {/* Form Container */}
        <div className="form-container bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mb-6">
            ...
            {isSignUp && (
              <div>
                <label htmlFor="displayName" className="text-sm font-medium text-gray-700 block mb-1">Full Name</label>
          ...
          <div className="space-y-2">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center px-4 py-2.5 border border-gray-300 rounded-lg text-gray-700 text-sm font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
